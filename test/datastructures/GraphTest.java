...
public class GraphTest {
    ...
    public void setupStage3() {
        ...
        graph.insertEdge(vertex1, vertexP);
        graph.insertEdge(vertex2, vertex4);
        graph.insertEdge(vertex2, vertex5);
        graph.insertEdge(vertexP, vertex6);
        graph.insertEdge(vertexP, vertex7);
    ...
    public void testInsertEdge1() {
        ...
        assertTrue(graph.insertEdge(vertex1, vertex2));
    }
    ...
    public void testInsertEdge2() {
        ...
        Vertex<String> vertex2 = new Vertex<>("B");
        graph.insertEdge(vertex1, vertex2);
        assertFalse(graph.insertEdge(vertex1, vertex2));
    }
    ...
    public void testInsertEdge3() {
        ...
        assertFalse(graph.insertEdge(vertex3, vertex1));
    }
